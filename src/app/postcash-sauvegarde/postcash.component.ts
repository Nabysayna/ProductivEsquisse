...
export class PostcashComponent implements OnInit {
  ...
  @ViewChild('modalvalidrechargementespece') modalvalidrechargementespece: ModalDirective;
  @ViewChild('modaljula') modaljula: ModalDirective;
  @ViewChild('modalreglementsenelec') modalreglementsenelec: ModalDirective;
  @ViewChild('modalcodewoyofal') modalcodewoyofal: ModalDirective;
  ...
  validrechargementespece(){
    ...
    this.loading = true ;
    sessionStorage.setItem('curentProcess',JSON.stringify({'nom':'post cash rechargement','operateur':1,'operation':1,'telephone':'00221'+this.telephone,'montant':this.montant}));
     this.hidemodalvalidrechargementespece();
     this.loading = false ;
  ...
  validateachatcodewoyofal(){
      ...
      sessionStorage.setItem('curentProcess',JSON.stringify({'nom':'post cash woyofal','operateur':1,'operation':4,'compteur':this.compteur,'montant':this.montant}));
      this.hidemodalcodewoyofal();
    /*  this.loading = true ;
...
/*
      sessionStorage.setItem('curentProcess',JSON.stringify({'nom':'post cash facture senelec','operateur':1,'operation':3,'numfacture':this.num_facture,'police':this.police}));
      this.hidemodalreglementsenelec();
*/
      this.hidemodalreglementsenelec() ;
  ...
  validatereglementsenelec(){
      ...
      sessionStorage.setItem('curentProcess',JSON.stringify({'nom':'post cash facture senelec','operateur':1,'operation':3,'numfacture':this.num_facture,'police':this.police, 'montant':this.detailfacturepostcash.montant}));
      this.loading = false;
  ...
  validateachatjula(){
     ...
     sessionStorage.setItem('curentProcess',JSON.stringify({'nom':'post cash jula','operateur':1,'operation':2,'montant':this.mt_carte,'nbcarte':this.nb_carte}));
     this.loading = false ;
     this.hidemodaljula();
  ...
  public showmodalvalidrechargementespece(){
    this.modalvalidrechargementespece.show();
  }
  public hidemodalvalidrechargementespece(){
    this.modalvalidrechargementespece.hide();
  }
  public showmodalreglementsenelec(){
    this.modalreglementsenelec.show();
  }
  public hidemodalreglementsenelec(){
    this.modalreglementsenelec.hide();
  }
  public showmodalcodewoyofal(){
    this.modalcodewoyofal.show();
  }
  public hidemodalcodewoyofal(){
    this.modalcodewoyofal.hide();
  }
  public showmodaljula(){
   if(this.nb_carte>0){
     this.modaljula.show();
    }
  }
  public hidemodaljula(){
    this.modaljula.hide();
  }
